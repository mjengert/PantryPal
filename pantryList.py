...
class PantryScreen(MDScreen):
    def __init__(self, *args, **kwargs):
        ...
        self.p_list_layout = MDGridLayout(cols=2, spacing=10,_md_bg_color=(0.588, 0.702, 0.824, .75),padding=10)
        ...
        self.title=(MDLabel(text="My Pantry",  pos_hint={"center_x": 0.5},padding='5sp', halign='center',
                                       size_hint=(1, 0.11),text_color=(0.588, 0.702, 0.824, 1),_md_bg_color=(0.588, 0.702, 0.824, .1)))
